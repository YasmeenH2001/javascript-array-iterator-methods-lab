...
// Complete the exercise in the space below:
 inventors.filter(inventors => inventors.year >= 1500 && inventors.year <= 1599)
...
totalYearsLived = inventors.reduce((total, inventors) => {
...
let travelMethodCounts = travelMethods.reduce((obj, item) => {
  if (!obj[item]) {
    obj[item] = 1;
  } else {
    obj[item] += 1;
